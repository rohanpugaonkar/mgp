      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-white">
            ...
            <div class="icon">
                <?= Html::img('@web/img/icons/icon5.png', ['alt' => 'Member-icon']);?>
            </div>
            <a href="<?= Url::to('member')?>" class="small-box-footer">
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-white">
            ...
            <div class="icon">
                <?= Html::img('@web/img/icons/icon7.png', ['alt' => 'staffMember-icon']);?>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-white">
            ...
            <div class="icon">
                <?= Html::img('@web/img/icons/icon1.png', ['alt' => 'group-icon']);?>
            </div>
            <a href="<?= Url::to('')?>" class="small-box-footer">
              More info <i class="fa fa-arrow-circle-right"></i>
            </a>
