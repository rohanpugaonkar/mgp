        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#intaketype" data-toggle="tab"><i class="fa fa-plus-circle"></i> Intake Type</a></li>
              <li><a href="#supplementationcategory" data-toggle="tab"><i class="fa fa-plus-circle"></i> Supplementation Category</a></li>
              <li><a href="#assignsuppliments" data-toggle="tab"><i class="fa fa-plus-circle"></i> Assign Supplements</a></li>
            </ul>
