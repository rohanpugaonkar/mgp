...
?>
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="nav-tabs-custom" id="diettabs">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#dietplanlist" data-toggle="tab"><i class="fa fa-list"></i> Diet Plan List</a></li>
              <li><a href="#addnutrition" data-toggle="tab"><i class="fa fa-plus-circle"></i> Add Diet Plan</a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="dietplanlist">
