        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#addmusclegroup" data-toggle="tab" class="c-yellow"><i class="fa fa-plus-circle"></i> Muscle Group</a></li>
              <li><a href="#addmusclewiseexercise" data-toggle="tab" class="c-blue"><i class="fa fa-plus-circle"></i> Muscle Wise Exercise</a></li>
              <li><a href="#cardio" data-toggle="tab" class="c-red"><i class="fa fa-plus-circle"></i> Cardio</a></li>
              <li><a href="#assignworkout" data-toggle="tab" class="c-magenta"><i class="fa fa-plus-circle"></i> Workout</a></li>
              <li><a href="#function_core" data-toggle="tab" class="c-green"><i class="fa fa-plus-circle"></i> Functional & Core</a></li>
            </ul>
