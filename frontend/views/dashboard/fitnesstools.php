        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#weighttracker" data-toggle="tab" class="c-yellow">Weight Tracker</a></li>
              <li><a href="#bodycomposition" data-toggle="tab" class="c-blue"> Body Composition</a></li>
              <li><a href="#proteincalculator" data-toggle="tab" class="c-red"> Protein Calculator</a></li>
              <li><a href="#cardiovasculartrackers" data-toggle="tab" class="c-magenta"> Cardio-Vascular Trackers</a></li>
              <li><a href="#fitnessassessment" data-toggle="tab" class="c-green"> fitness Assessment</a></li>
              <li><a href="#maxcalculator" data-toggle="tab" class="c-navy"> VO<sub>2</sub> Max Calculator</a></li>
              <li><a href="#milerockport" data-toggle="tab" class="c-teal"> 1-mile Rockport Test</a></li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="cardiovasculartrackers">
                <h3> Cardio-Vascular Trackers</h3>
                 <?php $form = ActiveForm::begin([
                    'id'=>'',
                    'options'=>[
                      'class' => 'form-horizontal',
              ...
              <div class="tab-pane" id="maxcalculator">
                <h3>VO<sub>2</sub> Max Calculator</h3>
                <?php $form = ActiveForm::begin([
                            'id'=>'',
                            'options'=>[
                              'class' => 'form-horizontal',
