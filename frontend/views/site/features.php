	...
	<div class="row">
		...
		<div class="col-xs-6 col-md-4 col-lg-4">
			<div class="block text-center">
				<div class="icon">
					 <?= Html::img('@web/img/icons/icon1.png', ['alt' => 'Membership Management']);?>
				</div>
		...
		<div class="col-xs-6 col-md-4 col-lg-4">
			<div class="block text-center">
				<div class="icon">
					<?= Html::img('@web/img/icons/icon2.png', ['alt' => 'Manage Expenses']);?>
				</div>
		...
		<div class="col-xs-6 col-md-4 col-lg-4">
			<div class="block text-center">
				<div class="icon">
					 <?= Html::img('@web/img/icons/icon3.png', ['alt' => 'Workout scheduling']);?>
				</div>
		...
		<div class="col-xs-6 col-md-4 col-lg-4">
			<div class="block text-center">
				<div class="icon">
					 <?= Html::img('@web/img/icons/icon4.png', ['alt' => 'Diet planning']);?>
				</div>
				<h4>Diet planning</h4>
		...
		<div class="col-xs-6 col-md-4 col-lg-4">
			<div class="block text-center">
				<div class="icon">
					 <?= Html::img('@web/img/icons/icon5.png', ['alt' => 'Fitness tools']);?>
				</div>
				<h4>Fitness tools</h4>
		...
		<div class="col-xs-6 col-md-4 col-lg-4">
			<div class="block text-center">
				<div class="icon">
					 <?= Html::img('@web/img/icons/icon6.png', ['alt' => 'Supplementation']);?>
				</div>
		...
		<div class="col-xs-6 col-md-4 col-lg-4">
			<div class="block text-center">
				<div class="icon">
					<?= Html::img('@web/img/icons/icon7.png', ['alt' => 'Personal training management']);?>
				</div>
		...
		<div class="col-xs-6 col-md-4 col-lg-4">
			<div class="block text-center">
				<div class="icon">
					<?= Html::img('@web/img/icons/icon8.png', ['alt' => 'Quick alerts']);?>
				</div>
				<h4>Quick alerts</h4>
		...
		<div class="col-xs-6 col-md-4 col-lg-4">
			<div class="block text-center">
				<div class="icon">
					<?= Html::img('@web/img/icons/icon10.png', ['alt' => 'Manage employees and trainers']);?>
				</div>
		...
		<div class="col-xs-6 col-md-4 col-lg-4">
			<div class="block text-center">
				<div class="icon">
					 <?= Html::img('@web/img/icons/icon9.png', ['alt' => 'Generate excel /pdf reports']);?>
				</div>
		...
		<div class="col-xs-6 col-md-4 col-lg-4">
			<div class="block text-center">
				<div class="icon">
					<?= Html::img('@web/img/icons/icon111.png', ['alt' => 'Billing and invoicing']);?>
				</div>
